...
// Insert the helper functions before the handleCheckStatus function
content = content.replace(
...
// 3. Inject Stepper inside checkedLead block
const idRujukanBlock = `                            <div className="flex items-center justify-between border-b border-dashed border-slate-200 pb-2">
...
const stepperInjection = `                            <div className="flex items-center justify-between border-b border-dashed border-slate-200 pb-2">
                              <span className="font-bold text-slate-500 uppercase text-[8px] tracking-widest">
                                ID Rujukan:
                              </span>
                              <span className="font-mono font-bold text-[#0F172A] bg-zinc-200/50 px-2 py-0.5 rounded text-[10px]">
...
content = content.replace(idRujukanBlock, stepperInjection);

// 4. Inject buttons at the end of checkedLead block
const oldBottomBlock = `                                  )}
                              </div>
                            </div>
                          </motion.div>
                        )}
...
const newBottomBlock = `                                  )}
                            ...
                            {/* Action Buttons: Cetak, Kongsi, Add to Calendar */}
                            <div className="flex items-center gap-2 pt-2 mt-2 border-t border-slate-200/60">
                              ...
                              <button
                                ...
                                className="flex-1 flex items-center justify-center gap-1.5 py-2 bg-[#25D366] hover:bg-[#128C7E] text-white rounded-xl text-[9px] font-bold uppercase tracking-wider transition-colors shadow-sm"
...
content = content.replace(oldBottomBlock, newBottomBlock);
