...
export const initialTestimonials: Testimonial[] = [
  {
    id: "test-1",
    clientName: "Ir. Ahmad Shahrir",
    clientCompany: "Jejaring Megah Sdn Bhd",
    feedback:
      "Sangat berpuas hati dengan ketepatan masa dan profesionalisme pasukan Bena Flash Global semasa memasang sistem pendingin hawa VRF di pejabat 5 tingkat kami. Prestasi penyejukan sangat cekap dan penjimatan tenaga terbukti ketara.",
    rating: 5,
    date: "12/03/2026",
    userId: "admin-seed-1",
    verified: true,
  ...
  {
    id: "test-2",
    clientName: "Puan Nooraini Zakaria",
    clientCompany: "Pusat Perubatan Penawar",
    feedback:
      "Kerja pendawaian semula sistem elektrik backup kecemasan dan pemasangan panel agihan (DB) yang dilakukan sangat kemas dan mematuhi piawaian Suruhanjaya Tenaga. Penerangan teknikal yang diberikan juga sangat jelas.",
    rating: 5,
    date: "28/04/2026",
    userId: "admin-seed-2",
    verified: true,
  ...
  {
    id: "test-3",
    clientName: "En. Faris Hakimi",
    clientCompany: "Apex Logistics Hub",
    feedback:
      "Respons yang sangat pantas daripada pasukan penyelenggaraan HVAC Bena Flash Global! Apabila sistem pendingin hawa utama kami mengalami kerosakan, mereka tiba dalam masa 2 jam dan menyelesaikan pembaikan dengan segera. Sangat disyorkan!",
    rating: 5,
    date: "15/05/2026",
    userId: "admin-seed-3",
    verified: true,
